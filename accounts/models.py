...
class User(AbstractBaseUser):
    ...
    email = models.CharField(max_length=56, unique=True)
    phone_number = models.CharField(max_length=12, blank=True, null=True)
    role = models.PositiveSmallIntegerField(choices=ROLE_OPTION, blank=True, null=True)
...
class UserProfile(models.Model):
    ...
    address_line_1 = models.CharField(max_length=56, blank=True, null=True)
    address_line_2 = models.CharField(max_length=56, blank=True, null=True)
